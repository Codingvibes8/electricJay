...
const Hero = ()=> {
    return(
        <section className={'relative h-500px] flex flex-col md:flex-row items-center justify-center gap-8 w-full z-30'}>

            <div className=' relative flex flex-col items-center mx-auto  gap-8  py-10'>
                <div className="max-w-lg bg-white  md:shadow-lg mx-auto px-4">
                    <h2 className="text-3xl text-center capitalize text-green-800 font-bold">Expert Electrical
                        Services</h2>
                    <div className="flex flex-col items-center justify-center">

                        <ul className={'max-w-2xl font-medium mx-auto flex flex-col items-center justify-center'}>
                            ...
                            <li className="
                            text-[1.1rem] pt-2 font-semibold flex items-center justify-center">Reliable solutions for
                                electrical
                                installations or repairs.
                            </li>

                            <li className="text-[1.1rem] flex font-semibold items-center  justify-center">Safety,
                                Efficiency, And Quality – My
                                commitment to you!
                            </li>
                        </ul>
